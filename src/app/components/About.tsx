    ...
    >
      ...
      >
        ...
        <p className="mt-2 font-semibold leading-relaxed text-sm md:text-base">
          ...
          their intricate rules. It&apos;s a place where a retired hitman, John
          Wick, is drawn back into a hidden world of assassins, governed by the
        ...
        <div className="mt-4 grid grid-cols-1 sm:grid-cols-3 gap-4">
          <motion.div
            ...
            className="flex flex-col items-center bg-red-900 bg-opacity-20 p-3 rounded-xl"
          >
